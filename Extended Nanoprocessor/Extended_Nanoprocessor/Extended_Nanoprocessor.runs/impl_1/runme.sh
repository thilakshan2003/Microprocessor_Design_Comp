...
HD_PWD='C:/Users/senil/Documents/Files/UoM/Academic/Sem 2/Digital Design/Labs/Extended_Nanoprocessor/Extended_Nanoprocessor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Nanoprocessor_Interface.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Nanoprocessor_Interface.tcl -notrace
